...
| funding | Funding metadata | 3 | .github/FUNDING.yml, FUNDING.yml | Funding metadata gives maintainers a visible route for sponsorship and sustainability support. |
