...
```text
The project is early, so I am not overstating adoption. Current evidence includes npm 0.5.1 latest, 356 npm downloads reported by the registry API, a published v0.5.1 release, a reusable GitHub Action, a clean npm smoke test returning 100/A, public CI/Repository health/CodeQL/Release, four field-audit issues, four PRs, and a v0.5.1 workflow demo with artifacts.
```
