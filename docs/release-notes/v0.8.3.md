...
- Copyable workflow examples now include the opt-in so first-time users run compatible JavaScript actions under Node.js 24 ahead of GitHub Actions' Node.js 20 removal.
