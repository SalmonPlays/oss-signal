...
- Public GitHub Action tag: https://github.com/SalmonPlays/oss-signal/tree/v0.8.1
...
| --- | --- | --- |
| Installable CLI | `npm exec --yes --package=oss-signal@0.8.1 -- oss-signal SalmonPlays/oss-signal --format json` | Reviewers can run the package without cloning this repository. |
