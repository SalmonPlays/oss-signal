...
- Public GitHub Action tag: https://github.com/SalmonPlays/oss-signal/tree/v0.9.5
...
| --- | --- | --- |
| Installable CLI | `npm exec --yes --package=oss-signal@0.9.5 -- oss-signal --version` | Reviewers can run the package without cloning this repository. |
