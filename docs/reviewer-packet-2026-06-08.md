...
The workflow evidence below points at the latest verified run set. The release run and branch checks verified code commit `8614cc1`.
...
| Verified workflow commit | `8614cc1` |
...
The Evidence verification run uploads an `oss-signal-evidence-verification` artifact with digest `sha256:ae537fee4c6ff3b27cc305e26d16ba80c8a3f18ca7898264a65599fdb86a1ba9`. The committed [evidence verification snapshot](evidence-verification.md) for the same checks returned PASS 14, SKIP 0, FAIL 0.
