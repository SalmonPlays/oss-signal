...
- npm package: https://www.npmjs.com/package/oss-signal (`0.8.1` latest after release)
...
The public registry should return `0.8.1` for both package version and `latest` dist-tag after the Node.js 24 runtime release.
...
A clean npm execution against the public GitHub repository should return version `0.8.1`, score `100`, grade `A`, and source `github`.
...
- The GitHub Action tag, npm package, release notes, and documentation all point to `0.8.1`.
