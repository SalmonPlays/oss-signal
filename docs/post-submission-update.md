...
- Release workflow run: https://github.com/SalmonPlays/oss-signal/actions/runs/26927039619
- Repository health workflow run: https://github.com/SalmonPlays/oss-signal/actions/runs/26927039621
...
The public registry returned `0.6.3` for both package version and `latest` dist-tag on 2026-06-04T03:01:28Z.
...
A clean npm execution against the public GitHub repository returned version `0.6.3`, score `100`, grade `A`, and source `github`.
...
- The GitHub Action tag, npm package, release notes, and documentation all point to `0.6.3`.
