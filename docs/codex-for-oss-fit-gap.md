...
| Meaningful usage | npm package is published, npm registry API reported 4014 last-month downloads for 2026-05-23 to 2026-06-21, GitHub Marketplace listing is live, and public Action runs produce artifacts. | Downloads are early and do not yet prove broad adoption. Two stars are not meaningful popularity proof. | One independent maintainer-owned workflow run using `SalmonPlays/oss-signal@v0.10.0`. |
