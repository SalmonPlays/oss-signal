...
| --- | --- | --- |
| Adoption | Help one external maintainer run `SalmonPlays/oss-signal@v0.7.0` in a public workflow. | [Issue #8](https://github.com/SalmonPlays/oss-signal/issues/8), then linked workflow run or maintainer reply in [adoption-evidence.md](adoption-evidence.md). |
