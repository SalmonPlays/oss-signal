...
| Installable CLI | https://www.npmjs.com/package/oss-signal | `0.9.2` is `latest` | Reviewers can run `npm exec --yes --package=oss-signal@0.9.2 -- oss-signal --version` from a clean temporary directory. |
| npm download API | 356 downloads for the last-month window, 2026-05-04 to 2026-06-02 | Checked 2026-06-09T01:47:01Z | Supporting distribution signal only; not claimed as broad adoption. |
| GitHub Action release | https://github.com/SalmonPlays/oss-signal/tree/v0.9.2 | Published tag | Public Action tag used by repository workflows; the separate public demo remains v0.8.4 evidence until refreshed. |
...
| Main repository dogfood | https://github.com/SalmonPlays/oss-signal/actions/workflows/repository-health.yml | Passing | Runs `SalmonPlays/oss-signal@v0.9.2` against this repository. |
...
Checked from GitHub on 2026-06-09T01:47:01Z.
