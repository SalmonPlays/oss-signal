...
| npm download API | 356 downloads for the last-month window, 2026-05-04 to 2026-06-02 | Checked 2026-06-12T01:09:33.238Z | Supporting distribution signal only; not claimed as broad adoption. |
...
| Main repository dogfood | https://github.com/SalmonPlays/oss-signal/actions/workflows/repository-health.yml | Passing | Runs `SalmonPlays/oss-signal@v0.9.6` and publishes Markdown, SARIF, and adoption-pack artifacts for this repository. |
...
Checked from GitHub on 2026-06-12T01:09:33.238Z.
