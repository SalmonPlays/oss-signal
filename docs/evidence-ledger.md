...
| --- | --- | --- | --- |
| Installable CLI | https://www.npmjs.com/package/oss-signal | `0.8.1` is `latest` | Reviewers can run `npm exec --yes --package=oss-signal@0.8.1 -- oss-signal SalmonPlays/oss-signal --format json`. |
...
| GitHub Action release | https://github.com/SalmonPlays/oss-signal/tree/v0.8.1 | Published tag | Public Action tag used by repository workflows; the separate demo is refreshed after release publication. |
...
| Main repository dogfood | https://github.com/SalmonPlays/oss-signal/actions/workflows/repository-health.yml | Passing | Runs `SalmonPlays/oss-signal@v0.8.1` against this repository. |
