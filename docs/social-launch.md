...
Do not claim broad adoption. The current evidence is a public npm package, GitHub Marketplace Action, self-audit, workflow demo, public field audits, and open external follow-up PRs.
