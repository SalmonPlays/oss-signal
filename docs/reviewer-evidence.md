...
The Codex for Open Source application was submitted on 2026-06-03. The npm package and Action tag continued to move after submission as normal OSS maintenance. If any submitted field references older evidence, treat `0.8.4` as the current maintained release and see [post-submission-update.md](post-submission-update.md).
...
- Action tag: https://github.com/SalmonPlays/oss-signal/tree/v0.8.4
- Release: https://github.com/SalmonPlays/oss-signal/releases/tag/v0.8.4
